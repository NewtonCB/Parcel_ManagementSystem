                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php
                                        $ret = mysqli_query($con, "select *from seats where is_taken=1");
                                        $cnt = 1;
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <td>Dar es Salaam</td>
                                                <?php } ?>
                                                <td><button class="btn btn-danger waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Delete Confirmed</button></td>
                                            </tr>
                                        <?php
                                            $cnt = $cnt + 1;
                                        } ?>
