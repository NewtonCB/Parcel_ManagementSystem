...
<html lang="en">
    ...
    <head>
        <title>Mkombe Parcel Dashboard</title>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="total-courier.php">Total Parcel/Cargo
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="courierpickup.php">Total Parcel/Cargo Pickup</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                   ...
                                   <a class="text-muted text-uppercase m-b-20" href="shipped.php">Total Transported</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="intransit.php">Instransit Parcel/Cargo</a>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="arriveddes.php">Total Parcel/Cargo Arrived at destination</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="zmdi zmdi-file-text float-right"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="outfordelivery.php">Total Parcel/Cargo Out for Delivery</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="delivered.php">Total Delivered Parcel/Cargo</a>
