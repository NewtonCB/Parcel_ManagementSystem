              ...
              <option value="<?php echo $rw['BranchName'];?>"><?php echo $rw['BranchName'];?></option>
                  <?php } ?>  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="<?php echo $row['StaffMobilenumber'];?>" id="" name="mobilenumber" maxlength="16" required="true" pattern="\+?[0-9]+">
                                        </div>
                                    </div>
                                    <div class="form-group row">
